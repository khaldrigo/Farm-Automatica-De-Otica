...
@patch("otica_scripts.evolution_sender.EVOLUTION_API_URL", "http://localhost:8080")
@patch("otica_scripts.evolution_sender.EVOLUTION_API_KEY", "sua_api_key_global")
@patch("otica_scripts.evolution_sender.EVOLUTION_INSTANCE_NAME", "OticaBot")
